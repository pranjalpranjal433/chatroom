...
<div class="position-relative overflow-hidden p-3 p-md-5  text-center bg-light">
  <div class="col-md-5 p-lg-5 mx-auto my-5">
    <h1 class="display-4 font-weight-normal">Anonymous Chatroom</h1>
    <hr>
    <p class="lead font-weight-normal">Anything to Anyone.<br>Chat with your friends without revealing your identity</p>
    <hr>
    <form action="claim.php" method="POST">
      <b>myAnonymousChat</b> <input type="text" name="room" id="room">
          <button class="btn btn-secondary" href="#">enter</button>
    </form>
  </div>
...
<footer class="container py-5">
  <div class="row">
    <div class="col-12 col-md">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="d-block mb-2" role="img" viewBox="0 0 24 24" focusable="false"><title>MyChatApp</title><circle cx="12" cy="12" r="10"/><path d="M14.31 8l5.74 9.94M9.69 8h11.48M7.38 12l5.74-9.94M9.69 16L3.95 6.06M14.31 16H2.83m13.79-4l-5.74 9.94"/></svg>
    ...
    <div class="col-6 col-md">
      ...
      <ul class="list-unstyled text-small">
        ...
        <li><a class="text-muted" href="#">Anonymous Chats</a></li>
        <li><a class="text-muted" href="#">Team feature</a></li>
        <li><a class="text-muted" href="#">Security</a></li>
        <li><a class="text-muted" href="#">Unlimited Chats</a></li>
        <li><a class="text-muted" href="#">Long Messages</a></li>
      </ul>
  </div>
      <div class="col-6 col-md">
      <h5><em>About</em></h5>
      <ul class="list-unstyled text-small">
        ...
        <li><a class="text-muted" href="#">XAMPP</a></li>
      </ul>
  </div>
</footer>
